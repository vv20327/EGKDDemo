...
def perturb_graph(features, adj, fea_mask_rate, edge_dropout_rate, args):
    ...
    if not args.sparse:
        ...
        #adj_l = cnv_sparse_mat_to_coo_tensor(values, adj.size())#
...
def main(args):
    ...
    #adj_hp = cnv_sparse_mat_to_coo_tensor(adj_hp, device)
    # if sp.issparse(features_1):
    #     features_1 = cnv_sparse_mat_to_coo_tensor(features_1, device).
    # else:
    ...
    for epoch in range(10):
        ...
        make_test_tSNE_KDGA(feature, label, cl_model, adj_1, adj_2, model_path, idx_test[:,epoch])
    print(111111111111111111111111111111111111111111111111111111111111111111111111111)
